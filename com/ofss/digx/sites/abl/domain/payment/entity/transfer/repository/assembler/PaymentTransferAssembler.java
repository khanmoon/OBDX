...
public MasterpassTransferRequestDomainDTO fromDomainObjectMasterpassTransfer(MasterpassTransfer masterpassTransfer) {
	 MasterpassTransferRequestDomainDTO masterpassTransferRequestDomainDTO = null;
	    if (masterpassTransfer != null)
	    {
	      ...
	      masterpassTransferRequestDomainDTO.setCreditAccountId(masterpassTransfer.getCreditAccountId());
	      masterpassTransferRequestDomainDTO.setCard_acceptor_name(masterpassTransfer.getCard_acceptor_name());
	      masterpassTransferRequestDomainDTO.setMerchant_category_code(masterpassTransfer.getCard_acceptor_name());
	      masterpassTransferRequestDomainDTO.setSender_first_name(masterpassTransfer.getSender_first_name());
	      masterpassTransferRequestDomainDTO.setSender_middle_name(masterpassTransfer.getSender_middle_name());
	      masterpassTransferRequestDomainDTO.setSender_last_name(masterpassTransfer.getSender_last_name());
	      masterpassTransferRequestDomainDTO.setSender_address_line1(masterpassTransfer.getSender_address_line1());
	      masterpassTransferRequestDomainDTO.setSender_address_city(masterpassTransfer.getSender_address_city());
	      masterpassTransferRequestDomainDTO.setSender_address_country(masterpassTransfer.getSender_address_country());
