...
public class MerchantTransferBusinessPolicy extends AbstractPaymentBusinessPolicy
{

    public MerchantTransferBusinessPolicy()
    {
    }

    public MerchantTransferBusinessPolicy(IBusinessPolicyDTO iBusinessPolicyDTO)
    {
        paymentBusinessPolicyData = (MerchantTransferBusinessPolicyData)iBusinessPolicyDTO;
    }
...
/* Added - 10th April - Muhammad Faheem */
    ...
    public MerchantTransferBusinessPolicyData getPaymentBusinessPolicyData()
    {
        return paymentBusinessPolicyData;
    }

    public void setPaymentBusinessPolicyData(MerchantTransferBusinessPolicyData paymentBusinessPolicyData)
    {
        this.paymentBusinessPolicyData = paymentBusinessPolicyData;
    }

    private static final String THIS_COMPONENT_NAME = MerchantTransferBusinessPolicy.class.getName();
    private static final MultiEntityLogger FORMATTER;
    private static final Logger logger;
    private MerchantTransferBusinessPolicyData paymentBusinessPolicyData;
