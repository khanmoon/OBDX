...
public class MasterpassTransferAuthentication extends AbstractApplication implements IMasterpassTransferAuthentication
{
  ...
  public MasterpassTransferAuthentication() {}
  


  public MasterpassTransferResponse validateToken(SessionContext sessionContext, MasterpassTransferValidateRequestDTO donationTransferValidateRequestDTO)
    throws Exception
  {
    ...
    try
    {
    	MasterpassTransfer donationTransferDomain = new MasterpassTransfer();
    ...
    catch (Exception e1)
    {
      ...
      logger.log(Level.SEVERE, formatter.formatMessage("Exception encountered while invoking the service %s while validating donation transfer payment", new Object[] {MasterpassTransferAuthentication.class
