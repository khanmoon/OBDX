...
public class CardlessWithdrawalApprovalAssembler
  extends AbstractApprovalAssembler<CardlessWithdrawalUpdateRequestDTO, AmountAccountTransaction>
{
  public CardlessWithdrawalUpdateRequestDTO fromDomainObject(AmountAccountTransaction transaction)
    throws Exception
  {
    return null;
  }
  
  public AmountAccountTransaction toDomainObject(CardlessWithdrawalUpdateRequestDTO requestDTO)
    throws Exception
  {
    ...
    if (requestDTO != null)
    {
      ...
      CardlessWithdrawalDomain MerchantTransfer = new CardlessWithdrawalDomain();
