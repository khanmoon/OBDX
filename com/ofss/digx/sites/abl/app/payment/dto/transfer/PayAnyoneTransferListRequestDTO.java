...
public class PayAnyoneTransferListRequestDTO
  extends DataTransferObject
{
  ...
  {
    return "PayAnyoneTransferListRequestDTO [fromDate" + this.fromDate + "toDate" + this.toDate + "PaymentStatusType" + this.status + "]";
  }
}
