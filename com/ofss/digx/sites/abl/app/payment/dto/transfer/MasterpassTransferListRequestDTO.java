...
public class MasterpassTransferListRequestDTO
  extends DataTransferObject
{
  ...
  {
    return "DonationTransferListRequestDTO [fromDate" + this.fromDate + "toDate" + this.toDate + "PaymentStatusType" + this.status + "]";
  }
}
