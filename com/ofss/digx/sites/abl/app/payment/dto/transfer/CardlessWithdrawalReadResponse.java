...
public class CardlessWithdrawalReadResponse
  ...
  implements IIndirection
{
  ...
  private static final String THIS_COMPONENT_NAME = CardlessWithdrawalReadResponse.class.getName();
  ...
  {
    return "CardlessWithdrawalReadRequestDTO [paymentId=" + this.paymentId + "transfer Details=" + this.transferDetails + "payee Details=" + this.payeeDetails + " ]";
  }
