...
public class MasterpassTransferResponse
  extends BaseResponseObject
{
  ...
  {
    return "DonationTransferResponse [external Reference Id=" + this.externalReferenceId + "is token Available" + this.tokenAvailable + "isTokenValid" + this.isTokenValid + " ]";
  }
}
