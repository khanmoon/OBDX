...
public class MasterpassTransferCreateRequestDTO
  ...
  implements IIndirection
{
  ...
  private MasterpassDTO transferDetails;
  
  public MasterpassTransferCreateRequestDTO() {}
  
  public MasterpassDTO getTransferDetails() { return transferDetails; }
  
  public void setTransferDetails(MasterpassDTO transferDetails) {
	  this.transferDetails = transferDetails;
  }
  
  public String toString()
  {
    return "MasterpassTransferCreateRequestDTO [transfer Details=" + transferDetails + " ]";
  }
