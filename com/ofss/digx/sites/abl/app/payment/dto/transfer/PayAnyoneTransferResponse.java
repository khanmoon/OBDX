...
public class PayAnyoneTransferResponse
  extends BaseResponseObject
{
  ...
  {
    return "PayAnyoneTransferResponse [external Reference Id=" + this.externalReferenceId + "is token Available" + this.tokenAvailable + "isTokenValid" + this.isTokenValid + " ]";
  }
}
