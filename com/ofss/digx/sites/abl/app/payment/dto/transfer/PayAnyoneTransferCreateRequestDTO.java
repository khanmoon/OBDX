...
public class PayAnyoneTransferCreateRequestDTO
  ...
  implements IIndirection
{
  ...
  private static final String THIS_COMPONENT_NAME = PayAnyoneTransferCreateRequestDTO.class.getName();
  ...
  private PayAnyoneTransferDTO transferDetails;
  
  public PayAnyoneTransferDTO getTransferDetails()
  {
    return this.transferDetails;
  }
  
  public void setTransferDetails(PayAnyoneTransferDTO transferDetails)
  {
  ...
  {
    return "PayAnyoneTransferCreateRequestDTO [transfer Details=" + this.transferDetails + " ]";
  }
